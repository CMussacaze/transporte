...
def exportar_reservas_excel(modeladmin, request, queryset):
    ...
    cabecalhos = [
        "ID", "Nome", "Telefone", "Rota", "Número da Rota",
        "Data da Viagem", "Paragem de Embarque", "Quantidade",
        "Usado", "Valor do Bilhete (Base da Comissão)", "Código do Bilhete"
    ]
...
exportar_reservas_excel.short_description = "📤 Exportar Reservas (Excel)"
...
class UsuarioAdmin(admin.ModelAdmin):
    ...
    list_display_links = ("nome",)  # ← ISSO ativa o link de edição
    search_fields = ("nome", "telefone", "email")

@admin.register(Veiculo)
class VeiculoAdmin(admin.ModelAdmin):
    list_display = ("id", "tipo", "capacidade", "status")
    list_display_links = ("tipo",)  # ← ISSO ativa o link de edição
    list_filter = ("tipo",)

@admin.register(VeiculoRota)
class VeiculoRotaAdmin(admin.ModelAdmin):
    list_display = ("id", "veiculo", "rota")
    list_display_links = ("veiculo",)  # ← ISSO ativa o link de edição
...
class ParagemAdmin(admin.ModelAdmin):
    ...
    list_display_links = ("rota",)  # ← ISSO ativa o link de edição
    list_filter = ("rota",)
    ordering = ("rota", "ordem")
