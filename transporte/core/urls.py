...
from .views import CidadeViewSet, RotaViewSet, ReservaViewSet, AgendaViagemViewSet, reservas_motorista, EncomendaViewSet, BilheteViewSet, reutilizar_bilhete_urbano, reutilizar_bilhete_interprovincial, login_motorista  # ← Inclui aqui
...
urlpatterns = [
    path('', include(router.urls)),  # Rotas automáticas (ViewSets)
    ...
    # 🔥 Endpoints MPESA com prefixo /api/
    path("iniciar-pagamento/", views_mpesa.iniciar_pagamento),
    path("mpesa-pagar/", views_mpesa.mpesa_pagar),
    path("mpesa-callback/", views_mpesa.mpesa_callback),
    path("mpesa-status/", views_mpesa.mpesa_status),
]
